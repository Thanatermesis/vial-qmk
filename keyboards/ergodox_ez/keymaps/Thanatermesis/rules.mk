...
# lets enable it on our own code instead
CAPS_LOCK_STATUS = no

COMBO_ENABLE = yes
MAGIC_ENABLE = yes           # special features like switching ctrl-caps on the fly: quantum/command.c
...
GRAVE_ESC_ENABLE = no
CAPS_WORD_ENABLE = no      # Caps Word automatically disables itself at the end of the word. That is, it stops by default once a space or any other key, or after 5 seconds, almost 1k
MIDI_ENABLE = no
ENABLE_ENCODERS = no       # no idea what is this for
MUSIC_ENABLE = no
RGBLIGHT_ANIMATION = no
RGBLIGHT_ENABLE = no        # Enable keyboard RGB underglow
SPACE_CADET_ENABLE = no
BLUETOOTH_ENABLE = no       # Enable Bluetooth
PROGRAMMABLE_BUTTON_ENABLE = no  # Programmable Buttons are keys that have no predefined meaning. This means they can be processed on the host side by custom software without the operating system trying to interpret them.
